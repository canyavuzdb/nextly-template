  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-red-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 ease">
              <span className="sr-only">Contact form Widget</span>
              <Transition
                show={!open}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          id="email"
                          {...register('email', {
                            required: 'Email girmediniz',
                            pattern: {
                              value: /^\S+@\S+$/i,
                              message: 'Email girmediniz',
                            },
                          })}
